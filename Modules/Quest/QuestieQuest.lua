                ...
                if(finisherZone ~= nil and spawns ~= nil) then
                    for _, coords in ipairs(spawns) do
                        ...
                        if(coords[1] == -1 or coords[2] == -1) then
                            _QuestieQuest:UpdateWaypointsOtherZone(data, finisher, finisherZone)
                        else
                            _QuestieQuest:UpdateWaypointsThisZone(data, finisher, finisherZone, coords)
                        end
                    end
                end
            end
...
function QuestieQuest:PopulateObjective(Quest, ObjectiveIndex, Objective, BlockItemTooltips) -- must be pcalled
    ...
    _QuestieQuest:InitAlreadySpawned(Objective);
    ...
    _QuestieQuest:RegisterItemTooltips(Objective, BlockItemTooltips, Quest)
